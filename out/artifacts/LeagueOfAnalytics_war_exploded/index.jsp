...
<div class="gridLayout">
    ...
    <div class="summonerTop"><input type="text" id="summoner1" placeholder="summoner1"></div>
    <div class="summonerJungle"><input type="text" id="summoner2" placeholder="summoner2"></div>
    <div class="summonerMid"><input type="text" id="summoner3" placeholder="summoner3"></div>
    <div class="summonerBot"><input type="text" id="summoner4" placeholder="summoner4"></div>
    <div class="summonerSupport"><input type="text" id="summoner5" placeholder="summoner5"></div>
