...
namespace ScoreCollector
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            StreamReader sr = File.OpenText(@"C:\Users\Mitchell\Desktop\LOA Data\Gold.txt");//Enter the file location of the list of summoners in a particular rank. (Diamond.txt, Platinum.txt, Gold.txt, Silver.txt, Bronze.txt)
            ...
            String startingSummoner = "make me win";//Enter a summoner from the list of summoners to start collecting data or continue from last point.
            ///////////////////////////////////////////////////////////////////////////////////////////////
